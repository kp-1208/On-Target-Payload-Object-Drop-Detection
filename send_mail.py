...
if __name__ == '__main__':
    ...
    '''prepare_and_send_email(sender='kshitij2020csai125@abesit.edu.in', 
                           recipient='kshitij.antiphishing@gmail.com',
                           subject= 'Greeting from Surveillance Unit', 
                           message_text= 'Hello, this is a test email from Drop Site Surveillance Unit',
